<header id="site-header" class="<?php lightning_the_class_name( 'site-header' ); ?>">
	...
	<div id="site-header-container" class="<?php lightning_the_class_name( 'site-header-container' ); ?> container">
		...
		<div class="headerUpper">
			...
			<div class="telForm">
				<div class="tel">
					<img src="http://iwamilaw2408.local/wp-content/uploads/2024/09/phone.png" alt="tel">
					<p>06-XXXX-XXXX</p>
				</div>
				<div class="form">
					<a href="<?php echo get_page_link(2647); ?>">
						<img src="http://iwamilaw2408.local/wp-content/uploads/2024/09/mail.png" alt="form">
						<p>フォームから相談する</p>
					</a>
				</div>
			</div>
